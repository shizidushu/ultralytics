...
setup(
    ...
    entry_points={'console_scripts': ['yolo = ultralytics.cfg:entrypoint', 'ultralytics = ultralytics.cfg:entrypoint', 'export_onnx_for_rknn = ultralytics.engine.export_onnx_for_rk3588:app']})
